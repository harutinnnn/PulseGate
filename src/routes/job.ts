...
export const jobRoute = (context: AppContext) => {
   ...
   */
  router.get('/jobs/:id', getJobHandler(context));
   ...
   *         description: Job not found
   */
  router.get('/jobs/:id/attempts', attemptController.list);
  ...
  /**
     ...
     *         description: Job not found
     */
  router.get('/jobs/:id/cancel', jobController.cancel);
   ...
   *         description: Job not found
   */
  router.get('/jobs/:id/retry', jobController.retry);
